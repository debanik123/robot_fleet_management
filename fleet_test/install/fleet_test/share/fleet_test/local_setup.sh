...
: ${AMENT_CURRENT_PREFIX:="/home/dj/robot_fleet_management/fleet_test/install/fleet_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fleet_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/fleet_test/environment/path.sh"
